...
// scripts/showcase-seed, see its README's "It is completely separate from
// the mobile app and Cloud Functions" note): nothing here is imported by,
// or imports from, either of those packages.
