...
class JoinCode {
  ...
  const JoinCode({required this.code, required this.leagueId, required this.teamId, required this.role, required this.createdByUserId, this.usedByUserId, required this.createdAt});
